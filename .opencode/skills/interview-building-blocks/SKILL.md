...
1. Load [[requirements/domain-decomposition]], [[requirements/aggregate-boundaries]] — gap analysis and boundary sizing. This level is structural decomposition, not CIT/Laddering elicitation (those served levels 1–2).
