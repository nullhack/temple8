...
2. Read `.cache/<session_id>/journal.md` (always present — bootstrapped at plan entry by `model-data-schema`). IF it carries escalation findings from build THEN adjust the source stubs of the contracts it names; otherwise skip.
